...
struct TouchGestureStateTests {
    ...
    @Test
    func `Verify that the initial state is .undetermined`() {
        let subject = Subject()
    ...
    @Test
    func `Verify that the state is still undetermined even when finger input is detected`() {
    ...
    @Test
    func `Verify that the state becomes .drawing`() {
        let cases: [[Int: [TouchPoint]]] = [
            [
                0: [
                    TouchPoint.generate(timestamp: 0, phase: .began),
    ...
    @Test
    func `Verify that the state becomes .transforming`() {
        let cases: [[Int: [TouchPoint]]] = [
            [
                0: [
                    TouchPoint.generate(timestamp: 0, phase: .began),
