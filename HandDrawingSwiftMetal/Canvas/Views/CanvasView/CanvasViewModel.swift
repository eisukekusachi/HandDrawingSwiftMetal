...
final class CanvasViewModel {
    ...
    init(
        ...
        // If `TextureDocumentsDirectorySingletonRepository` is used, `CanvasStateStorage` is enabled
        if textureRepository is TextureDocumentsDirectorySingletonRepository {
