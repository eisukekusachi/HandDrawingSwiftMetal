...
extension URL {
    ...
    /// A temporary directory URL used for file input and output
    static let tmpDirectory: URL = FileManager.default.temporaryDirectory.appendingPathComponent("tmpDirectory")
